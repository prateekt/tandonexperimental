...
public class PopulationNetworkController_old extends Controller {
	...
	public PopulationNetworkController_old(HammeringArm arm, Nail nail, int numNeuronsPerLayer) {
		this.arm = arm;
		this.nail = nail;
	...
	public void resetController() {
		...
		aPop = new CodedPopulation("Swing Theta population", numNeuronsPerLayer, 120.0);
...
//		System.out.println(a_decoded + " " + b_decoded);
		return action;
	}
