 ...
 */
package api.tuxguitar.tg_import.song.models;
...
public abstract class TGMeasure {
	...
	public void duplicateBeat(int index) {
		TGBeat beat = (TGBeat) beats.get(index);
		TGBeat newBeat=beat.clone(new TGFactory());
//		newBeat.makeRest();
		beats.add(index+1, newBeat);
	}
